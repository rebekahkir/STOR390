...
heart$heart_disease <- ifelse(heart$class == "present", "yes", "no")
heart$heart_disease <- factor(heart$heart_disease, levels = c("no", "yes"))
...
heart.tree <- rpart(High ~. -Sales, data = carseats, method = "class")
